...
function draw() {
    ...
    rectMode(CORNER);
    fill(255);
    rect(0, 0, pot_value, windowHeight);

    //if button is pressed, display ellipse whose size is controlled by the light sensor.
    if (button_state == 1) {
        ellipseMode(RADIUS);
        ellipse(windowWidth / 2, windowHeight / 2, light_value, 100);
        sound.play();
    }
