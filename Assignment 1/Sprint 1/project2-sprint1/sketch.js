...
function draw() {
    ...
    //If the button is pressed, play a sound and change the background colour.
    if (button_state == 1) {
        background(209, 17, 174);
        sound.play();
    } else {
        background(255, 255, light_value);
    }
    ...
    //Draw a rectangle that changes width with the potentiometer.
    rectMode(RADIUS);
    fill(0, 0, 255);
    rect(windowWidth / 2, windowHeight / 2, pot_value, 50);
